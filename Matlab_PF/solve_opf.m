%% Main function of AC/DC OPF Solving
% Performs an AC/DC Optimal Power Flow (OPF) analysis using the YALMIP framework.
% It loads AC and DC network parameters from specified case files, sets up the optimization
% variables and constraints for both the DC grid and AC networks, and then solves the 
% AC/DC OPF problem.

clc; clear all; close all;

%% 1. Set Case Names
caseName_dc = 'mtdc3slack_a';
caseName_ac = 'ac14ac57';

%% 2. Load AC and DC Parameters
...
%% 7. Extract Optimization Results (Convert to Numeric Values)
...
%       pd_ac        - Cell array. Active load at each bus.
%       qd_ac        - Cell array. Reactive load at each bus.
