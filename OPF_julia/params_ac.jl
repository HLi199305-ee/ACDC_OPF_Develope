...
Returns a NamedTuple with the following fields:
  ...
  - pd_ac             : Vector{Vector{Float64}}. Active/reactive loads (per unit).
  - qd_ac             : Vector{Vector{Float64}}. Mapping AC bus IDs to connected DC converters.
